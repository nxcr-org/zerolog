...
[![godoc](http://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](https://godoc.org/github.com/nxcr-org/zerolog) [![license](http://img.shields.io/badge/license-MIT-red.svg?style=flat)](https://raw.githubusercontent.com/nxcr-org/zerolog/master/LICENSE) [![Build Status](https://travis-ci.org/nxcr-org/zerolog.svg?branch=master)](https://travis-ci.org/nxcr-org/zerolog) [![Coverage](http://gocover.io/_badge/github.com/nxcr-org/zerolog)](http://gocover.io/github.com/nxcr-org/zerolog)
...
Find out [who uses zerolog](https://github.com/nxcr-org/zerolog/wiki/Who-uses-zerolog) and add your company / project to the list.
...
```bash
go get -u github.com/nxcr-org/zerolog/log
```
...
For simple logging, import the global logger package **github.com/nxcr-org/zerolog/log**
...
The `github.com/nxcr-org/zerolog/hlog` package provides some helpers to integrate zerolog with `http.Handler`.
