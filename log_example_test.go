...
func (h LevelNameHook) Run(ctx context.Context, e *zerolog.Event, l zerolog.Level, msg string) {
...
func (h MessageHook) Run(ctx context.Context, e *zerolog.Event, l zerolog.Level, msg string) {
